...
export interface TipWithExplanation extends TipBase {
    explanation: string;
}
...
export interface SectionWithExplanation {
    score: number;
...
export interface Feedback {
    ...
    ATS: ATSSection;
    toneAndStyle: SectionWithExplanation;
    content: SectionWithExplanation;
    structure: SectionWithExplanation;
    skills: SectionWithExplanation;
}
